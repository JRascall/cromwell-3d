...
better than this one has. [`unigine_clouds.md`](unigine_clouds.md) is read from
...
[`rdr2_atmospherics.md`](rdr2_atmospherics.md) is read from **Rockstar's own
...
[`rdr2_atmospherics.md`](rdr2_atmospherics.md) §5.2 describes Rockstar solving —
...
[`unigine_clouds.md`](unigine_clouds.md) §2 has the real version read from real
source. The skeleton:
...
([`unigine_clouds.md`](unigine_clouds.md) §6.1 — *"occlusion: a fixed cone, not a
...
- **RDR2** marches **one ray in four, reconstructed over four frames**
  ([`rdr2_atmospherics.md`](rdr2_atmospherics.md) §5.1).
- **UNIGINE** does **interleaved rendering, one pixel in N×N per frame**, plus
  reprojection and an upsample ([`unigine_clouds.md`](unigine_clouds.md) §8).
...
[`rdr2_atmospherics.md`](rdr2_atmospherics.md) is built on **froxel volume near,
...
- **Light *from the Earth*** is the expensive one. Cloud bases lit by city lights
  ...
  thing — [`rdr2_atmospherics.md`](rdr2_atmospherics.md) §6.4, **the volumetrics
...
- [`ruse.md`](ruse.md) §5 — **three kd-trees per map, split by *purpose*, not by
...
- [`rainbow_six_siege.md`](rainbow_six_siege.md) §4.9 — *"poking holes degrades
...
| | **DCS World** | **UNIGINE** ([note](unigine_clouds.md)) | **RDR2** ([note](rdr2_atmospherics.md)) |
|---|---|---|---|
...
[`source2_rendering.md`](source2_rendering.md) §13 already points at the froxel
...
5. **Erode, don't add** (§3). Start from a filled shape and subtract noise. This
   ...
   [`unigine_clouds.md`](unigine_clouds.md) has the real code.
