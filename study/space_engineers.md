...
already has its own note — [`moving_frame_navigation.md`](moving_frame_navigation.md)
...
> lighting, which VRAGE3 also uses; [`navigation.md`](navigation.md) for why
...
1. **Nothing can be baked, only incrementally re-baked.** A ship's collision
   ...
   the opposite direction ([`re_engine_rendering.md`](re_engine_rendering.md)
...
[`navigation.md`](navigation.md)'s core claim exactly: spatial queries and
...
in the RTS and FPS targets — see [`map_scale.md`](map_scale.md), which is about
...
pattern appears on the navigation side — [`moving_frame_navigation.md`](moving_frame_navigation.md)
...
1. **Sparse cluster storage over dense tiles** is the same conclusion as
   [`source2_rendering.md`](source2_rendering.md) §13 and this project's
...
[`moving_frame_navigation.md`](moving_frame_navigation.md) §3 — **the right
...
- **PBR.** VRAGE3 moved from Blinn-Phong to **GGX**, with importance-sampled
  ...
  **[inferred]** That last one is Toksvig/LEAN-style normal-variance-to-roughness
  ...
  maps. [`source2_rendering.md`](source2_rendering.md) covers the same ground.
...
That is the same conclusion as [`crowd_scale.md`](crowd_scale.md)'s central
...
**[inferred]** Independent confirmation of [`navigation.md`](navigation.md) §1
and [`spatial_queries.md`](spatial_queries.md): a game with an authoritative
...
[`moving_frame_navigation.md`](moving_frame_navigation.md) §4 already reads SE1's
...
[`moving_frame_navigation.md`](moving_frame_navigation.md) §3.1 quotes Kythera's
...
6. **Sparse light clusters.** §5.3. Matches the clustered-forward plan and
   [`source2_rendering.md`](source2_rendering.md) §13. The addition is the
...
12. **Physics clusters.** §3.3. 64-bit authoritative world, 32-bit local frames,
    **partition rather than rebase**, and a guaranteed margin rather than a hard
    ...
    ([`map_scale.md`](map_scale.md)) and should not be built until a project
    needs it.
