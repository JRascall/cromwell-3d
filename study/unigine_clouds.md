...
[`../tools/unigine_texture.py`](../tools/unigine_texture.py) decodes it. Format
...
Run through [`../tools/unigine_texture.py`](../tools/unigine_texture.py):
...
3. **§6.4's mip-by-distance environment fetch.** One `TEXTURE_BIAS` with a
   ...
   cubemap work that [`source2_rendering.md`](source2_rendering.md) §10 ranks
   third, and by smoke.
