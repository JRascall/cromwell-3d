...
> **Read alongside:** [`space_engineers.md`](space_engineers.md) — the wider SE
...
> [`elite_dangerous.md`](elite_dangerous.md) §3 for the contrasting planet
...
> [`rainbow_six_siege.md`](rainbow_six_siege.md) for the other destruction model:
> planar 2D cutting with faked debris, which is the right answer for buildings
> and the wrong one for terrain.
> [`re_engine_rendering.md`](re_engine_rendering.md) for signed distance fields
...
[`space_engineers.md`](space_engineers.md) §4.1, repeated because everything
...
[`space_engineers.md`](space_engineers.md) §4.2 has the architecture: **the
...
**[inferred] Which is [`navigation.md`](navigation.md)'s claim again, from a third
...
(see [`space_engineers.md`](space_engineers.md) §4.5), and ray-traced GI whose
...
sampling work in [`space_engineers.md`](space_engineers.md) §5.4 — with one
...
2. **Cheap baked occlusion from the occupancy data you already have (§3.4).**
   ...
   [`space_engineers.md`](space_engineers.md) §5.6, which it complements exactly.
