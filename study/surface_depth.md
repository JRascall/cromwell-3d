...
Companion to [`terrain_rendering.md`](terrain_rendering.md) — the same problem
...
[`terrain_rendering.md`](terrain_rendering.md) §5.4, and note that the two
...
**Related notes:** [`terrain_rendering.md`](terrain_rendering.md) §4.2 for
...
[`source2_rendering.md`](source2_rendering.md) for this renderer's material and
AO position.
