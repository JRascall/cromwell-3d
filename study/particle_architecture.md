...
in [`source2_particles.md`](source2_particles.md); this note decides *what
...
to get there ([`source2_particles.md`](source2_particles.md) A.7). Almost none of
...
does, confirmed twice ([`source2_particles.md`](source2_particles.md) A.7:
...
([`ai_state_machines.md`](ai_state_machines.md) §5.6). It is also what makes R21
...
([`source2_particles.md`](source2_particles.md) A.4). Every pre-emission operator
...
*Why:* [`helldivers2_vfx.md`](helldivers2_vfx.md) shows this is universal, not a
Valve quirk.
...
([`source2_particles.md`](source2_particles.md) §13.1).
...
in [`source2_particles.md`](source2_particles.md) §12A turns on the iteration
loop being fast.
