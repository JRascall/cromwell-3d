...
- [`navigation.md`](navigation.md) — the spatial and navigation layers underneath all of this, plus the GPU route and the two-population split from the rendering side
