...
Read against [`source2_animation.md`](source2_animation.md), which is the
...
In an animation graph ([`source2_animation.md`](source2_animation.md)) a human
...
[`source2_animation.md`](source2_animation.md) §4.4 warns about — *"combinatorial
...
| | AnimGraph ([`source2_animation.md`](source2_animation.md)) | Motion matching |
|---|---|---|
...
[`surface_depth.md`](surface_depth.md) §2 about photogrammetry, in a different
...
**Related notes:** [`source2_animation.md`](source2_animation.md) — the authored
...
[`spatial_queries.md`](spatial_queries.md) §3.6 — the candidate-scoring rules
