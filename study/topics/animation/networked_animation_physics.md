...
Companion to [`valve_networking.md`](../../games/valve/valve_networking.md) (one server, one
tick) and [`mmo_architecture.md`](../scale/mmo_architecture.md) (who owns what). This
...
[`source_fps_viewmodel.md`](../../games/valve/source_fps_viewmodel.md) §8.4 for the full chain.
...
lag compensation. From [`valve_networking.md`](../../games/valve/valve_networking.md) §7.3, the
...
[`mmo_architecture.md`](../scale/mmo_architecture.md):
...
**Related notes:** [`valve_networking.md`](../../games/valve/valve_networking.md),
[`mmo_architecture.md`](../scale/mmo_architecture.md),
[`source_fps_viewmodel.md`](../../games/valve/source_fps_viewmodel.md) §8 for the animation chain
in full.
