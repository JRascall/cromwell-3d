...
>
> **Superseded for R.U.S.E. — see [`ruse.md`](../../games/strategy/ruse.md).** The warning above was
...
| **R.U.S.E.** ([`ruse.md`](../../games/strategy/ruse.md) §1.1) | **1.7–10.3 km²** | **≤200** | low, but nothing like Wargame's |
...
[`ruse.md`](../../games/strategy/ruse.md) §3 and §4. The scorecard for §2's guesses, since it is worth
...
**Related notes**
- [`ruse.md`](../../games/strategy/ruse.md) — the first-party read of R.U.S.E.'s shipped build; supersedes §1.1 and §2 here
...
- [`navigation.md`](../agents/navigation.md) — the spatial index and navigation layers, and why the hash suits extent-dominated worlds
