...
This is the layer **above** [`valve_networking.md`](../../games/valve/valve_networking.md). That
...
topology you have five engines. Per [`valve_networking.md`](../../games/valve/valve_networking.md)
...
The transport, per [`valve_networking.md`](../../games/valve/valve_networking.md) §6:
...
for the network. That is the same rule as `study/topics/agents/spatial_queries.md` §5.2:
...
**Related notes:** [`valve_networking.md`](../../games/valve/valve_networking.md) for the layer
below (one server, one tick); [`networked_animation_physics.md`](../animation/networked_animation_physics.md)
