...
(parallax, POM, pixel depth offset); [`terrain_rendering.md`](../world/terrain_rendering.md)
...
| — | Substrate (§5) | Architectural, and this renderer is forward-clustered ([`source2_rendering.md`](../../games/valve/source2_rendering.md)) — a poor fit | large |
...
pixel depth offset; [`terrain_rendering.md`](../world/terrain_rendering.md) — layer
blending and anti-tiling, where §2's aliasing argument also applies;
[`source2_rendering.md`](../../games/valve/source2_rendering.md) — this renderer's shading and AO
position.
