...
> [`crowd_scale.md`](../scale/crowd_scale.md) (AC Unity, World War Z, Left 4 Dead — when
> the problem is *agent count*), [`battle_scale.md`](../scale/battle_scale.md) (Total War,
> Men of War — when it is *simulation depth*), and
> [`map_scale.md`](../scale/map_scale.md) (R.U.S.E., Wargame — when it is *extent*).
...
> [`nav_architecture.md`](../../plans/nav_architecture.md) — the representation catalogue,
