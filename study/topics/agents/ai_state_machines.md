...
candidate positions), [`gears_tactics.md`](../../games/strategy/gears_tactics.md) (how selfish agents
read as coordinated), [`navigation.md`](navigation.md) (how the chosen goal becomes
movement) and [`lod_systems.md`](../world/lod_systems.md) §7 (how many agents get to think
...
[`source2_animation.md`](../../games/valve/source2_animation.md)'s 399 hand-written animation
...
This is the same failure mode [`source2_animation.md`](../../games/valve/source2_animation.md) §7
...
[`rigging_ik.md`](../animation/rigging_ik.md) finding Ken Perlin's solver surviving the engine
...
3. **Two modes at 0.71 and 0.70 will swap on noise and the bot will thrash.**
   This is precisely the failure [`motion_matching.md`](../animation/motion_matching.md) §3.2
...
Unlike [`valve_networking.md`](../../games/valve/valve_networking.md) — where the wire protocol is
...
[`networked_animation_physics.md`](../animation/networked_animation_physics.md): decisions are
...
[`lod_systems.md`](../world/lod_systems.md) §7's AI-LOD argument appearing as a shipped
...
Same signal as [`rigging_ik.md`](../animation/rigging_ik.md) §4's two full-body IK solvers both
...
[`source2_animation.md`](../../games/valve/source2_animation.md) §7 — AnimGraph transition creation
...
the same conclusion [`rigging_ik.md`](../animation/rigging_ik.md) §6 reached for the animation
...
strategy slots — see [`gears_tactics.md`](../../games/strategy/gears_tactics.md). Dialogue and the
