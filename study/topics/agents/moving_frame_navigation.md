...
> [`crowd_scale.md`](../scale/crowd_scale.md) covers agent count. This one covers the
...
Tactics hit ([`gears_tactics.md`](../../games/strategy/gears_tactics.md) §2.2: content provoking
...
[`space_engineers.md`](../../games/space/space_engineers.md) §7.2 carries the same note.
...
> **The full design lives in [`nav_architecture.md`](../../plans/nav_architecture.md).** This
