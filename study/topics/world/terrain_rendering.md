...
[`source2_rendering.md`](../../games/valve/source2_rendering.md). Flagging it as an open thread
...
geomorphing, and the volume alternative; [`elite_dangerous.md`](../../games/space/elite_dangerous.md)
— planet-scale generated terrain and the point where terrain stops being
geometry; [`source2_rendering.md`](../../games/valve/source2_rendering.md) — this renderer's
