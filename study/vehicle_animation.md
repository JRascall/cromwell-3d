...
This is the note [`ruse.md`](ruse.md) and [`broken_arrow.md`](broken_arrow.md)
...
> read with [`../tools/ruse_edat.py`](../tools/ruse_edat.py) +
> [`../tools/ruse_ndf.py`](../tools/ruse_ndf.py).
>
...
> decoder is incomplete (see [`ruse.md`](ruse.md) §12). Every R.U.S.E. claim
...
Related: [`ruse.md`](ruse.md) (the engine this all sits on),
[`broken_arrow.md`](broken_arrow.md) (§10's convergence argument, of which this
note is the strongest single instance), [`source2_animation.md`](source2_animation.md)
and [`rigging_ik.md`](rigging_ik.md) (the same problems solved for one character
you stand next to), [`lod_systems.md`](lod_systems.md) (§5 here is a fifth
meaning of LOD), [`crowd_scale.md`](crowd_scale.md) (the same expensive-near /
cheap-far bet).
...
[`ruse.md`](ruse.md) §1.2 identifies for terrain: **the camera is allowed
...
[`ruse.md`](ruse.md) §11.1 finds spanning R.U.S.E., Red Dragon and WARNO. The
...
([`source_fps_viewmodel.md`](source_fps_viewmodel.md) §8), and correct for the
...
Compare [`source2_animation.md`](source2_animation.md): Valve's Citizen player
...
([`source2_animation.md`](source2_animation.md) §5). WARNO's is binary. At 200 m
...
That is [`crowd_scale.md`](crowd_scale.md)'s expensive-near / cheap-far bet
...
[`ruse.md`](ruse.md) §11.1's "652 classes survive verbatim" seen from the other
...
[`source2_animation.md`](source2_animation.md) §5 argues you need. WARNO's
...
[`broken_arrow.md`](broken_arrow.md) §10's "the structures converged anyway"
reading.
...
[`broken_arrow_audio.md`](broken_arrow_audio.md) §5.2 — the client-side visual
...
[`battle_scale.md`](battle_scale.md) names: count × depth ≈ constant.
...
[`nav_architecture.md`](nav_architecture.md)'s test — does it stay a drop-in for
...
[`ruse.md`](ruse.md) §12 do the binary work; WARNO's mod workspace is plain
text; Broken Arrow needs the six-line IL2CPP identifier extract in
[`broken_arrow.md`](broken_arrow.md) §12.
...
- **The WARNO mod workspace is the gameplay half only.** Engine-side classes do
  ...
  removal — that caveat from [`ruse.md`](ruse.md) §12 applies to every
...
**Tools**
- [`../tools/ruse_edat.py`](../tools/ruse_edat.py),
  [`../tools/ruse_ndf.py`](../tools/ruse_ndf.py) — see §11 for the two
  adjustments needed.

**Related notes**
- [`ruse.md`](ruse.md) — the engine; §11 is the twelve-year diff this note
  extends into the animation layer
- [`broken_arrow.md`](broken_arrow.md) — §10's convergence argument, of which §8
  here is the strongest instance
- [`broken_arrow_damage.md`](broken_arrow_damage.md) — the REST balance database
  §8.3's turret data is served from; the four-facing armour §8.4's `ArmorBone`
  implements
- [`source2_animation.md`](source2_animation.md) — the graph-based answer §7.2
  says Eugen abandoned
- [`rigging_ik.md`](rigging_ik.md) — the constraint and IK layer none of these
  four games has for vehicles
- [`lod_systems.md`](lod_systems.md) — §5 is a fifth meaning of LOD: cost
  removed by disabling named systems rather than by simplifying geometry
- [`crowd_scale.md`](crowd_scale.md), [`battle_scale.md`](battle_scale.md) —
