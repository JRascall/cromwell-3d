...
Written as the companion to [`gears_tactics.md`](gears_tactics.md), which raised
...
([`gears_tactics.md`](gears_tactics.md) §7.4): coordination expressed as a
...
per-cell enumeration itself.** [`elite_dangerous.md`](elite_dangerous.md) §3.6
...
Covered in [`gears_tactics.md`](gears_tactics.md) §2.3; summarised here for
