...
| **[VALVE-PROTO]** | Source 2 network schemas dumped from shipping binaries — see [`valve_networking.md`](valve_networking.md) for why this is trustworthy |
...
| **Procedurally generated on demand** | The *content*, generated from a seed as you approach. | Elite Dangerous, No Man's Sky — see [`elite_dangerous.md`](elite_dangerous.md) |
...
Covered in [`mmo_architecture.md`](mmo_architecture.md) §5, but the streaming
...
[`valve_networking.md`](valve_networking.md) for provenance.
...
half; [`mmo_architecture.md`](mmo_architecture.md) §5 — Star Citizen;
[`elite_dangerous.md`](elite_dangerous.md) — generated rather than paged;
[`voxel_terrain.md`](voxel_terrain.md) and [`space_engineers.md`](space_engineers.md)
— editable volume; [`valve_networking.md`](valve_networking.md) — where the
