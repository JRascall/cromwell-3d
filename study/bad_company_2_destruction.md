...
[`voxel_terrain.md`](voxel_terrain.md) / [`space_engineers.md`](space_engineers.md).
...
> lesson from the other direction. [`terrain_rendering.md`](terrain_rendering.md)
> for terrain generally; §3 here is the destruction-specific slice of the same
> Frostbite material. [`vehicle_animation.md`](vehicle_animation.md) §2.5 for
...
[`nuclear_option_damage.md`](nuclear_option_damage.md)'s blast model damaging
