...
> **Read alongside:** [`re_engine_rendering.md`](re_engine_rendering.md) — Siege's
> shadow system is the same cache-and-repair architecture, arrived at
> independently and under harder constraints.
> [`space_engineers.md`](space_engineers.md) for the other destructible-world
> game here, and §7 reads them against each other.
> [`source2_rendering.md`](source2_rendering.md) §13 for clustered lighting.
> [`elite_dangerous.md`](elite_dangerous.md) §2.4 for the other treatment of
...
conclusion [`elite_dangerous.md`](elite_dangerous.md) §3.6 reaches from a
...
This is the same idea as [`elite_dangerous.md`](elite_dangerous.md) §6.2's
...
a shape, and it has to be designed in.** [`moving_frame_navigation.md`](moving_frame_navigation.md)
...
([`elite_dangerous.md`](elite_dangerous.md) §3.1): **randomness derived from the
...
**[inferred]** This is [`re_engine_rendering.md`](re_engine_rendering.md) §1's
...
1. **This is a navigation graph.** Nodes, edges, edge costs, a shortest-path
   ...
   structure as [`navigation.md`](navigation.md)'s coarse area graph, serving a
...
7. **Resumability is a shape, not a retrofit.** §2.9. Siege hand-rolled
   ...
   [`moving_frame_navigation.md`](moving_frame_navigation.md) §8.2 argues the
...
11. **Seed randomness from the event, not from a stream.** §3.2 — Siege uses
    ...
    ([`elite_dangerous.md`](elite_dangerous.md) §3.1). Needs no synchronisation
    and no ordering.
...
13. **Cache the static, repair with the dynamic** — §4.6's cascade scheme is
    [`re_engine_rendering.md`](re_engine_rendering.md) §1 again, under the harder
...
14. **Sparse/clustered lighting with cubemaps as lights** — §4.7 matches the
    clustered-forward plan and [`source2_rendering.md`](source2_rendering.md)
    §13.
