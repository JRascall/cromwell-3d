...
Companion to [`crowd_scale.md`](crowd_scale.md), which is the same question
...
[`battle_scale.md`](battle_scale.md), which is Total War's simulation. This note
...
material that [`source2_animation.md`](source2_animation.md) is built from.
...
**[COMMUNITY]**, cross-referenced with [`battle_scale.md`](battle_scale.md):
...
is elsewhere. It is also why [`battle_scale.md`](battle_scale.md) says there is no LOD tier
...
1. **Bone-count LOD.** Skin the distant mesh to fewer bones, and skip evaluating
   ...
   **~300 bones near, 11 far** — are in [`crowd_scale.md`](crowd_scale.md); an
...
[`crowd_scale.md`](crowd_scale.md) and not repeated here; they are the
