...
| Reads from | For |
|---|---|
| [`navigation.md`](../topics/agents/navigation.md) | the four layers; where navmeshes stop scaling; why agent count and world size are different problems |
| [`crowd_scale.md`](../topics/scale/crowd_scale.md) | L4D's deliberately crude representation; why coarse + strong steering beats fine + weak |
| [`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) | moving frames, open volume, the library survey, the parallelism pass |
| [`spatial_queries.md`](../topics/agents/spatial_queries.md) | the neighbouring system this one must *not* absorb; §5.2's grid distance bias |
...
**Rejected:** a single `INavigation` facade. [`navigation.md`](../topics/agents/navigation.md)
...
fields over grids and tiles ([`navigation.md`](../topics/agents/navigation.md) §9;
[`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) §8.2). The interface
...
for grids ([`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) §3).
...
([`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) §6). Do not build
...
| **Direction-only** | AreaGraph | "generally that way" — the furthest unobstructed node ahead, re-evaluated per frame ([`crowd_scale.md`](../topics/scale/crowd_scale.md) §1.2) |
...
([`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) §7.3). When
...
say so first ([`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) §8.5).
...
| | Why |
|---|---|
| A navmesh generator | Recast is zlib and a voxelising generator is a project, not a feature. Keen reached the same split — library for the static world, hand-written only for the part that had to move ([`moving_frame_navigation.md`](../topics/agents/moving_frame_navigation.md) §4.1). |
| One system for all genres | [`navigation.md`](../topics/agents/navigation.md) §13. The attempt serves none of them. |
