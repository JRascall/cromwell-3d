...
[`valve_networking.md`](../games/valve/valve_networking.md) §6 reaches a conclusion that is
...
([`networked_animation_physics.md`](../topics/animation/networked_animation_physics.md) §2.3) are
...
Stated plainly, in the spirit of [`map_scale.md`](../topics/scale/map_scale.md)'s own warning
about Eugen.
