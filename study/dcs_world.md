...
The counterweight to [`nuclear_option.md`](nuclear_option.md) and its five companion
...
note](nuclear_option_combat.md) makes a virtue of the opposite — *"the AI is not
...
convergence [`broken_arrow.md`](broken_arrow.md) §10 observes for spatial
...
This is the direct counterpart to [`broken_arrow_damage.md`](broken_arrow_damage.md)
...
([`nuclear_option_combat.md`](nuclear_option_combat.md) §7):
...
[`nuclear_option_command.md`](nuclear_option_command.md) is richest: `TrackingInfo`
...
[`rdr2_atmospherics.md`](rdr2_atmospherics.md), which describes RDR2's answer to
...
Both [`rainbow_six_siege.md`](rainbow_six_siege.md) §4.9 (*"poking holes degrades
occlusion efficiency"*) and [`ruse.md`](ruse.md) §5 (three separate kd-trees split
...
- **DX11, deferred shading, PBR**, with the stated design constraint of looking
  ...
  extent problem [`map_scale.md`](map_scale.md) and
  [`elite_dangerous.md`](elite_dangerous.md) treat, at an intermediate scale.
...
the same conservation law [`battle_scale.md`](battle_scale.md) states for ground
combat (*count × depth ≈ constant*) and
[`broken_arrow_damage.md`](broken_arrow_damage.md) §5 states for damage (*a
...
[`broken_arrow_audio.md`](broken_arrow_audio.md)'s *"hand-rolled fails by being
