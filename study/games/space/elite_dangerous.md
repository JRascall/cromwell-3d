...
weaker evidence base than [`re_engine_rendering.md`](../rendering/re_engine_rendering.md)
...
- **The bake is view-independent but sun-dependent.** ED's sun moves slowly
  ...
  the same economics as [`re_engine_rendering.md`](../rendering/re_engine_rendering.md) §1's
...
[`spatial_queries.md`](../../topics/agents/spatial_queries.md) §5.2 documents: enumerating candidates
...
[`rdr2_atmospherics.md`](../rendering/rdr2_atmospherics.md) problem — froxel volumes, cloud
...
11. **Never enumerate a radial phenomenon over a lattice.** §3.6 — Horizons'
    ...
    [`spatial_queries.md`](../../topics/agents/spatial_queries.md) §5.2's grid distance bias, in a
...
- **Dense atmospheres as an increment on thin ones.** §5.3. Different problem,
  different note — [`rdr2_atmospherics.md`](../rendering/rdr2_atmospherics.md).
