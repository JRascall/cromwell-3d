...
[`broken_arrow.md`](../broken_arrow/broken_arrow.md) had to be; where an equation appears below,
...
Related: [`broken_arrow.md`](../broken_arrow/broken_arrow.md) (the buy-versus-build counterpart
in the same engine), [`space_engineers.md`](../../space/space_engineers.md) (the other
"simulate the assembly, not the object" game),
[`sea_of_thieves_water.md`](../../rendering/sea_of_thieves_water.md) (§11.6 is the contrast — a
game whose ocean *is* the physics), [`map_scale.md`](../../../topics/scale/map_scale.md),
[`moving_frame_navigation.md`](../../../topics/agents/moving_frame_navigation.md) (§9.4 is the same
moving-deck problem in the physics layer),
[`valve_networking.md`](../../valve/valve_networking.md) (§13 reads the authority model
against Valve's).
...
This is the same idea as [`space_engineers.md`](../../space/space_engineers.md)'s grids —
...
[`moving_frame_navigation.md`](../../../topics/agents/moving_frame_navigation.md), in the physics layer
...
[`sea_of_thieves_water.md`](../../rendering/sea_of_thieves_water.md)'s ocean, where the wave
...
elsewhere.** [`valve_networking.md`](../../valve/valve_networking.md)'s model — server
...
[`elite_dangerous.md`](../../space/elite_dangerous.md) needs two maths libraries and 64-bit
sector addressing because its extent is galactic;
[`space_engineers.md`](../../space/space_engineers.md) partitions into physics clusters rather
...
10. **Make a moving frame's velocity explicitly queryable.** (§9.4.)
    ...
    [`moving_frame_navigation.md`](../../../topics/agents/moving_frame_navigation.md), one layer down.
