...
[`broken_arrow_audio.md`](../broken_arrow/broken_arrow_audio.md) (**the A/B** — the same problem
space with FMOD and Resonance bought in), [`broken_arrow.md`](../broken_arrow/broken_arrow.md).
...
again. [`broken_arrow.md`](../broken_arrow/broken_arrow.md) ships FMOD Studio *and* Resonance —
