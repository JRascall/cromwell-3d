...
Mach cone),
[`spatial_queries.md`](../../../topics/agents/spatial_queries.md) (§1.3's batched raycasts and the
cheap-cull-before-expensive-test rule), [`ai_state_machines.md`](../../../topics/agents/ai_state_machines.md)
...
[`spatial_queries.md`](../../../topics/agents/spatial_queries.md) §3.6 applied exactly. It is also the
...
**[inferred]** Compare [`ai_state_machines.md`](../../../topics/agents/ai_state_machines.md): this is the
"each state owns its exit conditions" pattern, plus the tiered-update pattern from
[`space_engineers.md`](../../space/space_engineers.md) §6. Arrived at independently, which is
...
5. **Cheap geometric rejection before the expensive test.** (§1.2.) Two square
   ...
   [`spatial_queries.md`](../../../topics/agents/spatial_queries.md) §3.6.
