...
The counterpart to [`nuclear_option_damage.md`](../nuclear_option/nuclear_option_damage.md), the
...
Related: [`nuclear_option_damage.md`](../nuclear_option/nuclear_option_damage.md) (the A/B),
[`broken_arrow.md`](broken_arrow.md) (the parent note, same install, same method),
[`broken_arrow_audio.md`](broken_arrow_audio.md),
[`ruse.md`](../../strategy/ruse.md) §11.4 (Eugen's dice-roll resolution, the genre's other
tradition), [`battle_scale.md`](../../../topics/scale/battle_scale.md).
...
[`ruse.md`](../../strategy/ruse.md) §11.4) and *fly the projectile* (Men of War, and Nuclear
...
`flareRejection` ([`nuclear_option_combat.md`](../nuclear_option/nuclear_option_combat.md) §3.3) —
...
([`nuclear_option_damage.md`](../nuclear_option/nuclear_option_damage.md) §3): a single physically
...
([`nuclear_option.md`](../nuclear_option/nuclear_option.md) §3.3), a damaged joint's break force is
...
inputs away ([`nuclear_option_control.md`](../nuclear_option/nuclear_option_control.md) §1.3). Which
...
([`nuclear_option_damage.md`](../nuclear_option/nuclear_option_damage.md) §5) — which is why its type
...
- [`nuclear_option_damage.md`](../nuclear_option/nuclear_option_damage.md) — the other half of §9.
- [`ruse.md`](../../strategy/ruse.md) §11.4 — Eugen's resolution model, the genre's third answer.
