...
The control experiment for [`nuclear_option_audio.md`](../nuclear_option/nuclear_option_audio.md).
...
Related: [`nuclear_option_audio.md`](../nuclear_option/nuclear_option_audio.md) (the A/B),
[`broken_arrow.md`](broken_arrow.md) (the parent note — same install, same method),
[`ruse.md`](../../strategy/ruse.md).
...
[`nuclear_option_audio.md`](../nuclear_option/nuclear_option_audio.md) opens with — Doppler at high
...
from RPM and load the way [`nuclear_option_audio.md`](../nuclear_option/nuclear_option_audio.md) §6
...
[`nuclear_option_audio.md`](../nuclear_option/nuclear_option_audio.md) §2 identifies as the ceiling
...
([`nuclear_option.md`](../nuclear_option/nuclear_option.md) §7.7 is that bug in the physics). Broken
...
- [`nuclear_option_audio.md`](../nuclear_option/nuclear_option_audio.md) — the other half of the
  comparison.
