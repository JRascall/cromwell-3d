...
- **§5 is the payoff and the reason to write the note at all.** Read against
  [`sea_of_thieves_water.md`](../../rendering/sea_of_thieves_water.md) — which covers Sea of
...
[`unigine_clouds.md`](../../rendering/unigine_clouds.md), [`rdr2_atmospherics.md`](../../rendering/rdr2_atmospherics.md),
[`sea_of_thieves_water.md`](../../rendering/sea_of_thieves_water.md),
[`source2_rendering.md`](../../valve/source2_rendering.md), [`dcs_clouds.md`](dcs_clouds.md) —
...
that [`ruse.md`](../../strategy/ruse.md) §7.1 catches in R.U.S.E.'s tunable constants.
...
([`nuclear_option.md`](../nuclear_option/nuclear_option.md) §11), in a game with a fraction of the
budget:
...
([`sea_of_thieves_water.md`](../../rendering/sea_of_thieves_water.md) covers SoT, CS2 and — in
