...
.EXAMPLE
    .\tools\r6_extract.ps1 -List
    .\tools\r6_extract.ps1 -Kind mesh
    .\tools\r6_extract.ps1 -Pilot 1 -Kind texture     # time one archive first
    .\tools\r6_extract.ps1 -Slice 0 -Of 6
#>
[CmdletBinding()]
param(
...
Write-Host "Index with: py -3 tools\r6_index.py --build --out $Out\index.csv"
