...
Siege ships no asset names (see study/rainbow_six_formats.md), so the library has
...
deliberately the same shape.
    ...
    py -3 tools/r6_index.py --game "<install>" --list
    py -3 tools/r6_index.py --game "<install>" --build --out r6_extracted/index.csv
    py -3 tools/r6_index.py --library r6_extracted --query "mesh"
    py -3 tools/r6_index.py --library r6_extracted --query "texture>500000"
