<#
    ...
    xcom_extracted/models/materials.csv and (with -WriteMtl) real .mtl files.
        ...
        .\tools\xcom_materials.ps1                    # full sweep + build
        .\tools\xcom_materials.ps1 -BuildOnly         # re-join what is scanned
        .\tools\xcom_materials.ps1 -Slice 0 -Of 6     # one parallel worker
