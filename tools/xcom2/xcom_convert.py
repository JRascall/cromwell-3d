...
Usage
-----
    py -3 tools/xcom2/xcom_convert.py --raw workbench/xcom_raw/CinderblockWallA \
...
def write_obj(path: Path, pos, uv, nrm, faces_vi, faces_ti, mtl_name: str | None):
    ...
    lines = [f"# converted from XCOM 2 SDK export by tools/xcom2/xcom_convert.py",
...
def write_mtl(path: Path, name: str, diffuse: str | None, normal: str | None):
    lines = [f"# generated by tools/xcom2/xcom_convert.py", f"newmtl {name}",
