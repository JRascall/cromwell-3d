<#
    ...
    LIBRARY to build parcels out of, then index it.
        ...
        .\tools\xcom2\xcom_bulk.ps1                      # Environments + Vehicles
        .\tools\xcom2\xcom_bulk.ps1 -Subtree Environments\Rural
        .\tools\xcom2\xcom_bulk.ps1 -Pilot 10            # time a sample first
        .\tools\xcom2\xcom_bulk.ps1 -IndexOnly           # rebuild the CSV only
