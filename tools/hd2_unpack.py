...
almost nothing here. This writes that tree back out, byte for byte.
    ...
    py -3 tools/hd2_unpack.py --list
    py -3 tools/hd2_unpack.py --out hd2_extracted/data
    py -3 tools/hd2_unpack.py --out hd2_extracted/data --filter 000d250a
    py -3 tools/hd2_unpack.py --out hd2_extracted/data --slice 0 --of 6
