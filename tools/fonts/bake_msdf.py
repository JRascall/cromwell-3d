...
See study/topics/surfaces/distance_fields.md for why MSDF rather than SDF (corners), why the
...
tools/fonts/gen_fa_icons.py already uses for the icon vocabulary.

USAGE
    python tools/fonts/bake_msdf.py
